...
return [
	'links.link.label' => 'Link target',
	'links.text.label' => 'Link text',
	'links.text.help' => 'Optional, will be automatically generated from link target if not supplied.',
	...
	'links.navigation.label' => 'Navigation',
	'links.navigation.empty' => 'No menu items',
	'links.blocks.link.name' => 'Link',
